...
- [x] (#8) Implement tokenizer and parser with deterministic grammar, explicit operator precedence/associativity for `+ - * / ^`, decimals, parentheses, and structured parser errors [5 pts] (blocked by #1) (B)
